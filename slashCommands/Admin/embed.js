...
module.exports = {
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!
	//INFORMATIONS! You can add Options, but mind that the NAME MUST BE LOWERCASED! AND NO SPACES!!!, for the CHOCIES you need to add a array of arrays; [ ["",""] , ["",""] ] 
		...
		{"String": { name: "color", description: "What should be the embed colour?", required: false }}, //to use in the code: interacton.getString("color")
		//{"User": { name: "ping_a_user", description: "To ping a user", required: false }}, //to use in the code: interacton.getUser("ping_a_user")
		...
		//{"Role": { name: "what_role", description: "To ping a role", required: false }}, //to use in the code: interacton.getRole("what_role")
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message, GuildSettings) => {
    try{
		...
		await interaction?.editReply({content: `Sending the embed...`, ephemeral: true}).catch(() => null);
		//SEND THE EMBED!
